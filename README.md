...
5. Download the FaveSave zip from the [releases](https://github.com/joeycato/tiktok-favesave/releases) page and extract it to a local folder. After launching it, select the location of your JSON file ( e.g. *user_data_tiktok.json* ) , choose your output folder and preferences, then click **Start Download** to fetch your videos.
